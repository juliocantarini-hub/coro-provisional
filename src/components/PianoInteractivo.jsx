    ...
    <div style={{ marginBottom: 20 }}>
      <button
        ...
        style={{
          ...
          fontSize: 14, fontWeight: 500, color: "#04342C", width: "100%",
        }}
      >
        <span style={{ fontSize: 18 }}>🎹</span>
        <span style={{ flex: 1, textAlign: "left" }}>Buscá tu nota</span>
      ...
      {abierto && (
        <div style={{ padding: 16, border: "1px solid #ddd", borderTop: "none", borderRadius: "0 0 8px 8px", background: "#FFFFFF" }}>
